...
RUN wget https://archive.apache.org/dist/hadoop/common/hadoop-3.3.5/hadoop-3.3.5.tar.gz --progress=bar:force:noscroll \
    && tar xf hadoop-3.3.5.tar.gz \
    && mv hadoop-3.3.5 /usr/local/hadoop \
    && rm hadoop-3.3.5.tar.gz

RUN wget https://archive.apache.org/dist/spark/spark-3.3.4/spark-3.3.4-bin-hadoop3.tgz --progress=bar:force:noscroll \
